...
OBJFILES=error.o FileTools.o socket.o StringTools.o
ALL_OBJFILES=error.o FileTools.o socket.o StringTools.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
WUC=
EDITORS=
MAIN_TARGET=../lib/blib.a
PROJECT_ITEMS=error.cpp FileTools.cpp socket.cpp StringTools.cpp
DEFAULT_MASK=*.cpp
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= error.o FileTools.o socket.o StringTools.o 
NO_LINK=
...
error.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=FileTools.cpp
FileTools.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=socket.cpp
socket.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=StringTools.cpp
StringTools.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
all:: ../lib/blib.a
